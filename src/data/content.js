  ...
  es: {
    ...
    experience: {
      ...
      jobs: [
        ...
        { company: 'Delta Gas', role: 'Oracle APEX & PL/SQL Developer', period: 'Jun 2021 — Mar 2022', current: false, bullets: ['REST APIs con Oracle REST Data Services (ORDS).', 'Módulos backend con Oracle APEX, PL/SQL y JavaScript.', 'Lógica de base de datos para ventas, distribución y facturación.'], stack: ['Oracle APEX', 'PL/SQL', 'ORDS', 'JavaScript'] },
        { company: 'Delta Gas', role: 'Software Engineer', period: 'Jul 2020 — Ago 2021', current: false, bullets: ['REST y GraphQL APIs con Django, DRF y Graphene.', 'Infraestructura AWS: EC2, S3 y Amazon RDS.', 'Pipelines CI/CD con GitLab.'], stack: ['Django', 'GraphQL', 'AWS', 'GitLab CI/CD'] },
  ...
  en: {
    ...
    experience: {
      ...
      jobs: [
        ...
        { company: 'Delta Gas', role: 'Oracle APEX & PL/SQL Developer', period: 'Jun 2021 — Mar 2022', current: false, bullets: ['REST APIs with Oracle REST Data Services (ORDS).', 'Backend modules with Oracle APEX, PL/SQL and JavaScript.', 'Database logic for sales, distribution, and invoicing.'], stack: ['Oracle APEX', 'PL/SQL', 'ORDS', 'JavaScript'] },
        { company: 'Delta Gas', role: 'Software Engineer', period: 'Jul 2020 — Aug 2021', current: false, bullets: ['REST and GraphQL APIs with Django, DRF and Graphene.', 'AWS infrastructure: EC2, S3, and Amazon RDS.', 'CI/CD pipelines with GitLab.'], stack: ['Django', 'GraphQL', 'AWS', 'GitLab CI/CD'] },
